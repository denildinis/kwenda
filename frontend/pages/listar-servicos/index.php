...
<body>
  ...
  <?php include "../../components/pages/listar-servicos/section-list.php"; ?>
</body>
...
<script src="../../assets/js/pages/listar-servicos/list-services.js"></script>
<script src="../../assets/js/pages/eliminar-servico/delete-service.js"></script>
